export const DEFAULT_SETTINGS = {
  ...
  batterySaverAutoSleepMinutes: 20,
  batterySaverDiscardAudioTabs: false,
  batterySaverCollapseGroupsAfterSleep: true,
  limiterEnabled: true,
  limiterStartMinutes: 8,
  limiterSleepMinutes: 25,
  limiterProfile: "balanced",
  providers: {
    openai: {
      apiKey: "",
      model: "gpt-5.4-mini"
